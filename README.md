...
While Best Practices are recommendations that will help with security, performance, or architectural patterns that are solutions to a commonly occurring problems.
